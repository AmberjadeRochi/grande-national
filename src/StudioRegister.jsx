        ...
        <div style={{ display:"flex", gap:8, marginBottom:32 }}>
          {steps.map((s,i)=>(
            <div key={s} style={{ flex:1, textAlign:"center" }}>
              <div style={{ height:3, borderRadius:2, background:step>i?"#a78bfa":"#222", marginBottom:6 }} />
        ...
        <div style={S.card}>
          {step===1 && (
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
              ...
              <button style={S.btn("#a78bfa")} onClick={()=>{ if(!form.studio_name||!form.studio_email||!form.studio_code){notify("Studio name, email and code are required","#c0392b");return;} setStep(2); }}>Next →</button>
            </div>
          )}
          {step===2 && (
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
